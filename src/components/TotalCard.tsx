...
const TotalCard = ({ total, totalDaily, band, applianceCount }: TotalCardProps) => (
  <div className="gradient-vault rounded-3xl p-6 sm:p-8 text-primary-foreground shadow-elevated mb-6">
    ...
    <p className="text-sm opacity-70 font-mono mt-1">
      ₦{totalDaily.toLocaleString('en-NG', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}/day
    </p>
